...
class Movie(Panel):
    ...
    the movie using the soundfile attribute. This has added benefits - 
    you can play sounds from a variety of formats, and play the movie
    alongside multiple sounds.
    """
